<template>
    <layout>
        <fullpage>
            ...
            <static-title>ПАРТНЕРАМ И АВТОРАМ</static-title>
    
            <section-partners />
            <div class="line"></div>
            <footer-default class="no-bg" />
        </fullpage>
        ...
        <popup>
            ...
            <popup-text>Ваш email подтвержден, авторизуйтесь в приложении  Artifactum</popup-text>
        </popup>
